...
// this amount of data is still too much to send. According to the sound lever
// meter standard, we need to send short Leq values, which is 8 pieces per second
